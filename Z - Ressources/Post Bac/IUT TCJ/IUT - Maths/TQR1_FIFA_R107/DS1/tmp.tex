...
%\section*{R\'esolution de probl\`emes}
  ...
  % 8 min
\exost Questions sur le cours (4 points)
\begin{itemize}
 \item Qu'est ce qu'un nombre rationnel? Donnez un exemple.
 ...
 \item \`A quoi correspond le nombre d'or $\varphi$?
\end{itemize}
...
\begin{minipage}{0.45\textwidth}
 \begin{itemize}
  \item[.] $A = \frac{5}{3} (-\frac{4}{3} + \frac{1}{2})$ \ifcorrection  \fi \\   
