...
%------------------- TITRE -----------------------------------------
\date{Septembre 2022} 
\TDHead{\universityname}{\deptname}{R1.07, \years}{\large TD1: Calculs et r\'esolution d'\'equations}
%-------------------------------------------------------------------
...
\exost R\'ealiser les calculs suivants sans calculatrice et proposer une forme exacte r\'eduite des expressions suivantes:
...
%  \item[.] $I=\frac{x^3+3x^2+3x+1}{(x+1)^2}$
 \end{itemize}
\end{minipage}
...
\exost R\'esoudre les \'equations suivantes du second degr\'e et en donner une forme factoris\'ee:
  ...
  \begin{enumerate}
   ...
   permettant de couvrir les frais. %% 36,66
